...
Original file is located at
    https://colab.research.google.com/drive/1W3p5V-g4CC0mAwgspzMrIGkZKabTyx-_
"""
...
# 図を描写する
def DrawWeatherElements(year, month, day, place, weatherData, show=False, save_directory="."):
  time = weatherData["時間"]
